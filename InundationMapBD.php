...
modImages = new Array();
        modImages[0] = "flood/Flood-1.jpg";
        modImages[1] = "flood/Flood-2.jpg";
        modImages[2] = "flood/Flood-3.jpg";
        modImages[3] = "flood/Flood-4.jpg";
        modImages[4] = "flood/Flood-5.jpg";
        modImages[5] = "flood/Flood-6.jpg";
first_image = 0;
last_image = 5;
...
<body bgcolor="#ffffff" onLoad="launch()">
    ...
    <div class="row">
        <div class="container">
            <div class="col-sm-12">
                <h3>Forecasted Inundation Map</h3>
                <br />
            </div>
            ...
            <div class="col-sm-4">
                <div class="btn-group" >
                    <label data-toggle="tooltip" data-placement="top" title="5 Days Flood Bulletin" class="btn btn-secondary">
                        <a href="BulletinBD.php">Flood Bulletin</a>
                    </label>
                    <label data-toggle="tooltip" data-placement="top" title="Structure Based Flood Forecast" class="btn btn-secondary">
                        <a href="StructureBasedForecastBD.php">Structure Based Forecast</a>
                    </label>
                </div>
            </div>
            <p><IMG style="width:100%" name="animation" BORDER="0" src="flood/FloodMap_0.jpg"></p>
        </div>
    </div>
